        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function attachEventsToRow(row) {
                    ...
                    // You can copy and adapt your existing cascading dropdown JS here
                    ...
                    category.addEventListener('change', function() {
                        ...
                        // Load specs
                        fetch(`/get-attributes?category_id=${categoryId}`)
                            .then(res => res.json())
                            .then(data => {
                    ...
                    brand.addEventListener('change', function() {
                        ...
                        fetch(`/get-attributes?category_id=${categoryId}&sub_category_id=${subCatId}`)
                            .then(res => res.json())
                            .then(data => {
                                spec.innerHTML = '<option value="">Select Spec</option>';
                                data.forEach(item => {
                    ...
                    spec.addEventListener('change', function() {
                        ...
                        let url = `/get-products?category_id=${categoryId}&attribute_id=${attrId}`;
